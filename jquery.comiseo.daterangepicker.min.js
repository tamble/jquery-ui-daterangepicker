...
b("body").append(u).append(k);f();x();g()})();return{toggle:G,destroy:function(){k.remove();m.getElement().remove();e.show()},open:C,close:n,setRange:y,getRange:function(){return E(e.val())},clearRange:function(){m.reset();q.reset()},reset:x,getContainer:function(){return k}}}var w=0;b.widget("comiseo.daterangepicker",{version:"0.3.4",options:{presetRanges:[{text:"Today",dateStart:function(){return moment()},dateEnd:function(){return moment()}},{text:"Yesterday",dateStart:function(){return moment().subtract("days",
